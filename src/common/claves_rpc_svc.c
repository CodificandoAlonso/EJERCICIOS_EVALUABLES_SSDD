...
{
	union {
		entry set_value_1_arg;
		int get_value_1_arg;
		int delete_key_1_arg;
		entry modify_value_1_arg;
		int exist_1_arg;
	} argument;
	char *result;
	...
	case GET_VALUE:
		...
		_xdr_result = (xdrproc_t) xdr_GetRes;
	...
	case INIT_SERVICE:
		...
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) init_service_1_svc;
		break;

	case DESTROY_SERVICE:
		_xdr_argument = (xdrproc_t) xdr_void;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) destroy_service_1_svc;
		break;
